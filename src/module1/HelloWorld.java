...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(800, 600, P2D);  // Set up the Applet window to be 1280x720
	    ...
	    map1.zoomAndPanTo(zoomLevel, new Location(-22.91f, -43.72f));
		...
		map2.zoomAndPanTo(zoomLevel, new Location(28.51f,77.39f));
